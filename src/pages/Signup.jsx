    ...
    <div style={styles.container}>
      ...
      <div style={styles.signupBox}>
        ...
        <form onSubmit={submit} style={styles.form}>
          ...
          <div style={styles.inputGroup}>
            ...
            <input 
              ...
              required 
            />
            <p style={styles.passwordHint}>Passwords must be at least 6 characters.</p>
          </div>
        ...
        <div style={styles.businessSection}>
          ...
          <a href="#" style={styles.businessLink}>Create a free business account</a>
        </div>
        ...
        <p style={styles.termsText}>
          By creating an account or logging in, you agree to Amazon's <a href="#" style={styles.link}>Conditions of Use</a> and <a href="#" style={styles.link}>Privacy Notice</a>.
        </p>
